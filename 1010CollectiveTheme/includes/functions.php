 ...
 */
    ...
    */
    ...
    function bck_get_post_meta() {
        printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'bckspace' ),
...
<?php 
     ...
     */
     ...
     function bck_slider_build() {
        if(get_option('company_banner')) :
            echo '<img src="' . get_option('company_banner') . '" border="0" alt="primary-banner" />';
        else :
